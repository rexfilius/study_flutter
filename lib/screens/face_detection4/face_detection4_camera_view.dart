...
class FaceDetection4CameraView extends StatefulWidget {
  const FaceDetection4CameraView({
    super.key,
    required this.title,
    this.customPaint,
    this.text,
  ...
  @override
  State<FaceDetection4CameraView> createState() =>
      _FaceDetection4CameraViewState();
}

class _FaceDetection4CameraViewState extends State<FaceDetection4CameraView> {
  ...
  Future _switcherCamera() async {
    setState(() {
      _changeCameralens = true;
    });
    _cameraIndex = (_cameraIndex + 1) % cameras.length;
    await _stopLive();
    await _startLive();
    setState(() {
      _changeCameralens = false;
    });
  }
  ...
  Future _processCameraImage(CameraImage image) async {
    ...
    //
    late InputImageMetadata inputImageMetadata;
